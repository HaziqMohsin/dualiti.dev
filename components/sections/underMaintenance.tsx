export default function UnderMaintenance() {
  return (
    <div className="relative w-full mx-auto flex flex-col items-center justify-center bg-secondary-800 py-24 lg:py-52 h-full lg:h-screen">
      <div className="w-full flex flex-col gap-2 text-center">
        <div className="w-full lg:w-1/2 mx-auto text-5xl lg:text-9xl text-primary-100 font-black uppercase">
          Oo<span className="text-primary-400">pps 🕳️</span>
        </div>
